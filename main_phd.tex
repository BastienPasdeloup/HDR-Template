...
% Choose template
\documentclass[phd, english, include_uncited_refs]{template/hdr}
...
% Chapters
\input{manuscript/phd/acknowledgements}
\input{manuscript/phd/introduction}
\input{manuscript/phd/state_of_the_art}
\input{manuscript/phd/contribution}
\input{manuscript/phd/conclusion}

% Appendices
\appendices
\input{manuscript/phd/proofs}
