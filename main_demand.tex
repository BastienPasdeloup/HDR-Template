...
% Choose template
\documentclass[hdr_demand, french, include_uncited_refs]{template/hdr}
...
\input{manuscript/demand/foreword}
\input{manuscript/demand/cv}
\input{manuscript/demand/research}
