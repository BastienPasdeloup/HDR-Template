...
\documentclass[hdr, english, unnumbered_in_toc, include_uncited_refs, group_appendices_in_toc]{template/hdr}
...
% Bibliography
% Each category groups the entries whose "group" field matches the first argument
...
% Chapters
\input{manuscript/hdr/foreword}
\input{manuscript/hdr/acknowledgements}
\input{manuscript/hdr/introduction}
\input{manuscript/hdr/past}
\input{manuscript/hdr/future}

% Appendices
\appendices
\input{manuscript/hdr/cv}
