...
Additional material is provided in \nameref{cv}, and the document closes on the \nameref{bibliography} and the list of \nameref{glossary}.
These two chapters are unnumbered, just like the \nameref{foreword} and the \nameref{acknowledgements} opening the document, and are therefore recalled by their title rather than by a number.
