...
\chapter*[foreword]{Foreword}
    ...
    \section*[tldr]{TL; DR}
        ...
        Use it for a foreword, acknowledgements, or anything that should not carry a chapter number.
    ...
    \section*[reading_guide]{How to Read This Document}
        ...
        The template used for this document is available at \cite{template_repo}.
