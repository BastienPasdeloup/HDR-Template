...
Note that \acro{cnn_plural} is a separate entry of \verb|acronyms.tex|, declared as a variation of \verb|cnn|: its full name is \acroname{cnn_plural}, it does not appear in the list of acronyms, and its link leads to the entry of the acronym it varies.
...
The document opens on the \nameref{phd_acknowledgements} and closes on the \nameref{bibliography} and the list of \nameref{glossary}: these three chapters are unnumbered, and are therefore recalled by their title rather than by a number.
